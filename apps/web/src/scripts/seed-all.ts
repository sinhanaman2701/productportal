          ...
          children: [
            {
              type: "heading",
              tag: "h2",
              children: [{ type: "text", text: "Moving Beyond the MVP" }],
            },
            {
              type: "paragraph",
              children: [{ type: "text", text: "User expectations have drastically shifted. The modern MVP is not a buggy prototype; it is a sharply focused slice of exceptional utility." }],
            },
          ],
          direction: "ltr",
          format: "",
